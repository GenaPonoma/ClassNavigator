...
/**
 * ScheduleHtmlParser — утилитный объект для парсинга HTML-страницы расписания ВГТУ.
 * Позволяет извлекать список занятий (Course) из HTML-кода таблицы расписания.
 *
 * @author AI
 */
object ScheduleHtmlParser {
    /**
     * Парсит HTML-страницу и возвращает список занятий (Course).
     * @param html HTML-код страницы расписания
     * @return Список занятий (Course)
     */
